...
document.getElementById('yesBtn').addEventListener('click', function() {
    // Update the variable to indicate "Yes" button is clicked
    yesClicked = true;
    
    // Event listener for "Yes" button on the first page
document.getElementById('yesBtn').addEventListener('click', function() {
    console.log("Yes button on the first page was clicked.");
    // Add your code here to perform other actions
});
...
document.getElementById('noBtn').addEventListener('click', function() {
    // Update the variable to indicate "No" button is clicked
    noClicked = true;

    // Event listener for "No" button on the first page
document.getElementById('noBtn').addEventListener('click', function() {
    console.log("No button on the first page was clicked.");
    // Add your code here to perform other actions
});
});

// Variable to keep track of button clicks for the second set of buttons
let yes2Clicked = false;
let no2Clicked = false;

// Event listener for "Yes" button on the second page
document.getElementById('yesBtn2').addEventListener('click', function() {
    // Update the variable to indicate "Yes" button is clicked on the second page
    yes2Clicked = true;
    
    // Event listener for "Yes" button on the second page
document.getElementById('yesBtn2').addEventListener('click', function() {
    console.log("Yes button on the second page was clicked.");
    // Add your code here to perform other actions
});
...
// Event listener for "No" button on the second page
document.getElementById('noBtn2').addEventListener('click', function() {
    // Update the variable to indicate "No" button is clicked on the second page
    no2Clicked = true;

    // Event listener for "No" button on the second page
document.getElementById('noBtn2').addEventListener('click', function() {
    console.log("No button on the second page was clicked.");
    // Add your code here to perform other actions
});
});